...
# Tsv files
Source_files = glob.glob("/home/anu/Desktop/s_tsv/*.tsv")
# print(Source_files)
for s_file in Source_files:
    bookName = s_file.split("/")[-1].split(".")[0]
    fileName = s_file.split("/")[-1]
    s_Path = glob.glob("/home/anu/Desktop/s_tsv/" + str(fileName))
    t_Path = glob.glob("/home/anu/Desktop/Gujarati/xlsx/" + str(bookName) + ".xlsx")
    # print(s_Path)
    # print(t_Path)
    # print(bookName)
#     # Open Target File
